...
top_model = load_model('models/InceptionResNetV2/LSTM/top_model.hdf5', custom_objects={'top1_loss':top1_loss})
x = base_model.output
...
file_path = 'models/InceptionResNetV2/LSTM/inception_resnet_lstm.hdf5'
