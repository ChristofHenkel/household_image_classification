...
top_model = load_model('models/MobileNet/SeperableConv/top_model.hdf5', custom_objects={'top1_loss':top1_loss})
x = base_model.output
...
file_path = 'models/MobileNet/SeperableConv/mobilenet_sepconv.hdf5'
