...
top_model = load_model('models/MobileNet/BiLSTM_256/top_model.hdf5', custom_objects={'top1_loss':top1_loss})
x = base_model.output
...
file_path = 'models/MobileNet/BiLSTM_256/mobilenet_bilstm.hdf5'
