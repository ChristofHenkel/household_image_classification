...
top_model = load_model('models/Inceptionv3/Inception_Dense/top_model.hdf5', custom_objects={'top1_loss':top1_loss})
x = base_model.output
...
file_path = 'models/Inceptionv3/Inception_Dense/inception_dense.hdf5'
