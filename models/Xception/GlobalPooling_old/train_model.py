...
top_model = load_model('models/Xception/GlobalPooling/top_model_0.0001_0.4.hdf5', custom_objects={'top1_loss':top1_loss})
x = base_model.output
...
file_path = 'models/Xception/GlobalPooling/model.hdf5'
