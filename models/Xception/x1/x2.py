...
from keras.layers import Dense, Flatten,GlobalAveragePooling2D, Conv2D, MaxPooling2D, ConvLSTM2D, TimeDistributed , CuDNNLSTM, Dropout
...
file_path = 'models/Xception/x1/x2.hdf5'
