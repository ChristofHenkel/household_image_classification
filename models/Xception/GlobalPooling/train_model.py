...
from keras.layers import Dense, Concatenate,Bidirectional,GlobalMaxPool2D,SpatialDropout1D,CuDNNGRU, Dropout, Flatten, Conv2D, MaxPooling2D,GlobalMaxPooling2D, ConvLSTM2D, TimeDistributed , CuDNNLSTM,GlobalAveragePooling2D
...
main2 = GlobalMaxPool2D()(base_model.output)
main = Concatenate()([main, main2])
...
file_path = 'models/Xception/Gru_GlobalPooling_2/model.hdf5'
...
with open('models/Xception/Gru_GlobalPooling_2/history.p','wb') as f:
    pickle.dump(history.history,f)

with open('models/Xception/Gru_GlobalPooling_2/' + 'train_data_gen.p','wb') as f:
