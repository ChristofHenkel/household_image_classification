...
from keras.layers import Dense, Dropout,Bidirectional,CuDNNLSTM, SpatialDropout1D, Flatten, Conv2D, MaxPooling2D,GlobalMaxPooling2D, ConvLSTM2D, TimeDistributed , CuDNNLSTM,GlobalAveragePooling2D
...
BATCH_SIZE = 16
MODEL_PATH = 'models/DenseNet201/LSTM512/'
...
main = TimeDistributed(Bidirectional(CuDNNLSTM(512)))(base_model.output)
main = SpatialDropout1D(0.6)(main)
main = Bidirectional(CuDNNLSTM(512))(main)
main = Dropout(0.6)(main)
