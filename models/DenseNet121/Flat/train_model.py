...
top_model = load_model(path + 'top_model_256_0.5.hdf5', custom_objects={'top1_loss':top1_loss})
x = base_model.output
...
with open(path + 'summary_model.txt', 'a') as f:
    f.write(', '.join([str(best_val), str(best_val_top1)]) + '\n')
